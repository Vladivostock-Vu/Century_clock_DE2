...
//If tens is even, then units must be 0, 4, or 8
//If tens is odd, then units must be 2 or 6
assign div4 = (~tens[0] && (units == 4'd0 || units == 4'd4 || units == 4'd8)) ||
              ( tens[0] && (units == 4'd2 || units == 4'd6));

//Check if the year is divisible by 100
assign div100 = tens == 4'd0 && units == 4'd0;

//Check if the year is divisible by 400
//The year must be divisible by 100 and the year's hundreds must be divisible by 4
assign div400 = div100 && 
                (~thousands[0] && (hundreds == 4'd0 || hundreds == 4'd4 || hundreds == 4'd8)) ||
                ( thousands[0] && (hundreds == 4'd2 || hundreds == 4'd6));
